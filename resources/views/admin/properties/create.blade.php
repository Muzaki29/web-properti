...
@section('title', 'Tambah Property - Admin')
...
<div class="mb-8">
    ...
    <h1 class="text-3xl font-bold text-gray-900">Tambah Property Baru</h1>
</div>
    ...
    <form action="{{ route('admin.properties.store') }}" method="POST" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div>
                ...
                <input type="number" name="land_size" value="{{ old('land_size') }}" min="0" step="0.01"
                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#8BAE66] focus:border-[#8BAE66] outline-none">
            </div>
            
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">Luas Bangunan (m²)</label>
                <input type="number" name="building_size" value="{{ old('building_size') }}" min="0" step="0.01"
                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#8BAE66] focus:border-[#8BAE66] outline-none">
            </div>
        </div>
